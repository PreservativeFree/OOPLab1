...
console.log(totalPopulation(largeStates)); 
//////////////////////////// PROBLEM 9 ////////////////////////////
...
let Acacia = new Cat('Acacia', 2, 'black');
console.log(Acacia.name);
...
//Code here
class Wizard {
  constructor(wizName, age, favoriteSpell) {
  ...
  castSpell() {
    console.log(`${this.wizName} has cast ${this.favoriteSpell}`);
  }
}
let battleCleric = new Wizard("Archimedes", 34, "Reducto");
battleCleric.castSpell();
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let phoneOne = new Phone("Samsumg", "Galaxy S22", 320, 'Coal Black', 849.99);
let phoneTwo = new Phone("Apple", "iPhone 13", 256, "Midnight", 1099.99);
let phoneThree = new Phone("Google", "Pixel 6", 256, "Stormy Black", 899.99);
/* 
...
class Vehicle {
    ...
    move(miles) {
      this.mileage += miles;
      console.log(`The car has moved ${this.mileage} miles`);
    }
}
...
//Code Here
let myFirstVehicle = new Vehicle(4, "Blue", 200);
...
let myFirstMotorcycle = new Motorcycle(1, "Deep Red", 100, "Kawasaki", true);
...
let myFirstBoat = new Boat(250, "white", 5, "SeaQuest", "yacht", false);
